class HocSinh:
    ...
    def avg(self):
        return (self.__m1 *2+ self.__m2 * 2 + self.__m3 + self.__m4 + self.__m5 + self.__m6 + self.__m7 + self.__m8 + self.__m9 + self.__m10)/12
    ...
    def __str__(self):
        return f'{self.__id} {self.__name} {round(self.avg() + 0.00000001,1)} {self.classify()}'
